...
public class MetroplusConfig extends BaseAPI {
    public Properties loadProperties() throws IOException {
        Properties prop = new Properties();
        InputStream ism = new FileInputStream("src/main/resources/metroPlusConfig.properties");
        prop.load(ism);
